	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				surfaceDescription.BaseColor = ( ( _Color * tex2DNode89 ) + ( _Color_Tilling * tex2DNode89 * simplePerlin2D152 ) ).rgb;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 tex2DNode89 = tex2D( _Base_Color, uv_Base_Color );
				float2 texCoord154 = packedInput.ase_texcoord2.xy * _Tilling + float2( 0,0 );
				float simplePerlin2D152 = snoise( texCoord154*_Tilling_Color );
				simplePerlin2D152 = simplePerlin2D152*0.5 + 0.5;
...
Node;AmplifyShaderEditor.SamplerNode;115;54.26059,-407.1914;Inherit;True;Property;_Normal;Normal;13;1;[Normal];Create;True;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=38FDBC4811E3EB65D3BEB89D54639A7A74C48623